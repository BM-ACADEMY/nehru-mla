  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-red-50 py-20 md:py-28">
      ...
      <div className="relative container mx-auto px-4 md:px-8 lg:px-16">
        ...
        >
          <h2 className="text-4xl p-2   md:text-5xl font-extrabold bg-gradient-to-r  from-[#0033A0] via-[#D62828] to-black bg-clip-text text-transparent drop-shadow-md leading-tight ">
